...
struct Light2DComponent {
    ...
    bool cullWhenOffscreen = true;      // false = keep rendering even when fully off-screen (small maps / spawn lights)
    float offscreenCullMargin = 0.0f;   // extra world-space distance past the view edge kept loaded before culling
