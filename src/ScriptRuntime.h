...
#define MODULARITY_NATIVE_SCRIPT_ABI_VERSION 4 // god forbid me that i have to REMIND myself to change this one value so i don't keep asking AI about Compilation issues. :sob:
