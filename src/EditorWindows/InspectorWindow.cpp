...
void Engine::renderInspectorPanel() {
    ...
    const bool inspectorOpen = ImGui::Begin("Inspector", &showInspector);
    ImGui::PopStyleVar();
    if (!inspectorOpen) {
        ImGui::End();
        return;
        ...
        if (header.open) {
            ...
            if (obj.ui.type == UIElementType::Slider || obj.ui.type == UIElementType::Button) {
                if (drawInspectorSubsectionFoldout("Color Overrides")) {
                    ...
                    if (ImGui::ColorEdit4("Fill Color", &fillCol.x)) {
                    ...
                    if (ImGui::ColorEdit4("Background Color", &bgCol.x)) {
                    ...
                    if (ImGui::ColorEdit4("Border Color", &borderCol.x)) {
                    ...
                    if (ImGui::ColorEdit4("Label Color", &textCol.x)) {
                        obj.ui.textColor = glm::vec4(textCol.x, textCol.y, textCol.z, textCol.w);
                        changed = true;
                    }
                    if (obj.ui.type == UIElementType::Slider) {
                        if (ImGui::DragFloat("Label Font Size", &obj.ui.fontSize, 0.5f, 0.0f, 128.0f, "%.1f")) {
            ...
            if (obj.ui.type == UIElementType::Text) {
                ImVec4 textCol(obj.ui.textColor.r, obj.ui.textColor.g, obj.ui.textColor.b, obj.ui.textColor.a);
                if (ImGui::ColorEdit4("Text Color Override", &textCol.x)) {
                    obj.ui.textColor = glm::vec4(textCol.x, textCol.y, textCol.z, textCol.w);
                    changed = true;
                }
    ...
    if (inspectorComponentKey == "reflection_cast" && obj.hasReflectionCast && sharedReflectionCast) {
        ...
        auto header = drawComponentHeader("Reflection Cast", "ReflectionCast", "reflection_cast", &obj.reflectionCast.enabled, true, [&]() {
            drawStandardComponentMenu(
                "reflection_cast",
                "Copy Component Values",
                "Paste Component Values as New",
