...
namespace DragPreview {
    ...
    void UpdateAndRender() {
        ...
        if (hasIcon) {
            ...
            dl->AddImageQuad(s.icon, i0, i1, i2, i3, ImVec2(0.0f, 1.0f), ImVec2(1.0f, 1.0f), ImVec2(1.0f, 0.0f), ImVec2(0.0f, 0.0f), ApplyAlpha(IM_COL32_WHITE, s.opacity)); // Editor textures are uploaded bottom-up (OpenGL convention), so flip V.
